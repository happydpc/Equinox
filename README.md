...
Data analysis and visualisation software for digital-twin platform. Digital-twin platform aims at creating a digital fatigue representation of an engineering structure. This project contains the prototype desktop client application of the platform, named as Equinox. The application is developed using JavaFX framework.
