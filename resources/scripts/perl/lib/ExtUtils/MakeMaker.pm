...
sub full_setup {
    ...
    INST_ARCHLIB INST_SCRIPT INST_BIN INST_LIB INST_MAN1DIR INST_MAN3DIR INST_HTMLDIR
    INSTALLDIRS
    ...
    INSTALLMAN1DIR          INSTALLMAN3DIR INSTALLHTMLDIR
    INSTALLSITEMAN1DIR      INSTALLSITEMAN3DIR INSTALLSITEHTMLDIR
    INSTALLVENDORMAN1DIR    INSTALLVENDORMAN3DIR INSTALLVENDORHTMLDIR
 ...
 pm_to_blib selfdocument
    ...
    @Prepend_parent = qw(
           ...
           MAP_TARGET INST_MAN1DIR INST_MAN3DIR INST_HTMLDIR PERL_SRC
           PERL FULLPERL
    );
}
...
INSTALLDIRS according to the following table:
  ...
  INST_HTMLDIR   INSTALLHTMLDIR  INSTALLSITEHTMLDIR  INSTALLVENDORHTMLDIR
...
Directory to hold the html documentation at 'make' time
