...
#define OPTION_MASK_ABI_64 (HOST_WIDE_INT_1 << 3)
#define MASK_80387 (1 << 1)
#define MASK_USE_8BIT_IDIV (1 << 2)
#define OPTION_MASK_ISA_ABM (HOST_WIDE_INT_1 << 4)
#define MASK_ACCUMULATE_OUTGOING_ARGS (1 << 3)
#define OPTION_MASK_ISA_ADX (HOST_WIDE_INT_1 << 5)
#define OPTION_MASK_ISA_AES (HOST_WIDE_INT_1 << 6)
#define MASK_ALIGN_DOUBLE (1 << 4)
#define MASK_NO_ALIGN_STRINGOPS (1 << 5)
#define OPTION_MASK_ISA_AVX (HOST_WIDE_INT_1 << 7)
#define OPTION_MASK_ISA_AVX2 (HOST_WIDE_INT_1 << 8)
#define MASK_AVX256_SPLIT_UNALIGNED_LOAD (1 << 6)
#define MASK_AVX256_SPLIT_UNALIGNED_STORE (1 << 7)
#define OPTION_MASK_ISA_BMI (HOST_WIDE_INT_1 << 9)
#define OPTION_MASK_ISA_BMI2 (HOST_WIDE_INT_1 << 10)
#define MASK_CLD (1 << 8)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1 << 11)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1 << 12)
#define MASK_MACHO_DYNAMIC_NO_PIC (1 << 9)
#define OPTION_MASK_ISA_F16C (HOST_WIDE_INT_1 << 13)
#define MASK_NO_FANCY_MATH_387 (1 << 10)
#define OPTION_MASK_ISA_FMA (HOST_WIDE_INT_1 << 14)
#define OPTION_MASK_ISA_FMA4 (HOST_WIDE_INT_1 << 15)
#define MASK_FLOAT_RETURNS (1 << 11)
#define OPTION_MASK_ISA_FSGSBASE (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_ISA_FXSR (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_ISA_HLE (HOST_WIDE_INT_1 << 18)
...
#define OPTION_MASK_ISA_LWP (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_ISA_LZCNT (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_ISA_MMX (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1 << 22)
#define MASK_MS_BITFIELD_LAYOUT (1 << 16)
#define MASK_NO_PUSH_ARGS (1 << 17)
#define MASK_NO_RED_ZONE (1 << 18)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1 << 23)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 19)
#define OPTION_MASK_ISA_PCLMUL (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 25)
#define MASK_PREFER_AVX128 (1 << 20)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_ISA_RDRND (HOST_WIDE_INT_1 << 27)
#define OPTION_MASK_ISA_RDSEED (HOST_WIDE_INT_1 << 28)
#define MASK_RECIP (1 << 21)
#define MASK_RTD (1 << 22)
#define OPTION_MASK_ISA_RTM (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_ISA_SAHF (HOST_WIDE_INT_1 << 30)
#define OPTION_MASK_ISA_SSE (HOST_WIDE_INT_1 << 31)
#define OPTION_MASK_ISA_SSE2 (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_ISA_SSE3 (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_ISA_SSE4_2 (HOST_WIDE_INT_1 << 34)
#define OPTION_MASK_ISA_SSE4A (HOST_WIDE_INT_1 << 35)
#define MASK_SSEREGPARM (1 << 23)
#define OPTION_MASK_ISA_SSSE3 (HOST_WIDE_INT_1 << 36)
#define MASK_STACK_PROBE (1 << 24)
#define OPTION_MASK_ISA_TBM (HOST_WIDE_INT_1 << 37)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 25)
#define MASK_VECT8_RETURNS (1 << 26)
#define MASK_VZEROUPPER (1 << 27)
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1 << 38)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1 << 39)
...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 290,          /* -Wnonportable-cfstrings */
  OPT_Wnormalized_ = 291,                    /* -Wnormalized= */
  OPT_Wnull = 292,                           /* -Wnull */
  OPT_Wold_style_cast = 293,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 294,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 295,           /* -Wold-style-definition */
  OPT_Wout_of_date = 296,                    /* -Wout-of-date */
  OPT_Wover_ann = 297,                       /* -Wover-ann */
  OPT_Woverflow = 298,                       /* -Woverflow */
  OPT_Woverlength_strings = 299,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 300,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 301,                  /* -Woverride-init */
  OPT_Wp_ = 302,                             /* -Wp, */
  OPT_Wpacked = 303,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 304,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 305,                         /* -Wpadded */
  OPT_Wparam_assign = 306,                   /* -Wparam-assign */
  OPT_Wparentheses = 307,                    /* -Wparentheses */
  OPT_Wpedantic = 308,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 309,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 310,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 311,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 312,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 313,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 314,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 315,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 316,                       /* -Wprotocol */
  OPT_Wpsabi = 317,                          /* -Wpsabi */
  OPT_Wraw = 318,                            /* -Wraw */
  OPT_Wreal_q_constant = 319,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 320,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 321,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 322,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 323,            /* -Wredundant-modifiers */
  OPT_Wreorder = 324,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 325,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 326,                    /* -Wreturn-type */
  OPT_Wselector = 327,                       /* -Wselector */
  OPT_Wsequence_point = 328,                 /* -Wsequence-point */
  OPT_Wserial = 329,                         /* -Wserial */
  OPT_Wshadow = 330,                         /* -Wshadow */
  OPT_Wsign_compare = 331,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 332,                /* -Wsign-conversion */
  OPT_Wsign_promo = 333,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 334,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 335,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 336,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 337,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 338,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 339,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 340,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 341,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 342,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 343,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 344,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 345,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 346,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 347,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 348,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 349,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 350,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 351,                       /* -Wsuppress */
  OPT_Wsurprising = 352,                     /* -Wsurprising */
  OPT_Wswitch = 353,                         /* -Wswitch */
  OPT_Wswitch_default = 354,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 355,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 356,                      /* -Wsync-nand */
  OPT_Wsynth = 357,                          /* -Wsynth */
  OPT_Wsynthetic_access = 358,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 359,                 /* -Wsystem-headers */
  OPT_Wtabs = 360,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 361,                /* -Wtarget-lifetime */
  OPT_Wtasks = 362,                          /* -Wtasks */
  OPT_Wtraditional = 363,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 364,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 365,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 366,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 367,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 368,                    /* -Wtype-limits */
  OPT_Wuncheck = 369,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 370,            /* -Wundeclared-selector */
  OPT_Wundef = 371,                          /* -Wundef */
  OPT_Wunderflow = 372,                      /* -Wunderflow */
  OPT_Wuninitialized = 373,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 374,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 375,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 376,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 377, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 378,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 379,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 380,                         /* -Wunused */
  OPT_Wunused_argument = 381,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 382,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 383,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 384,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 385,                /* -Wunused-function */
  OPT_Wunused_import = 386,                  /* -Wunused-import */
  OPT_Wunused_label = 387,                   /* -Wunused-label */
  OPT_Wunused_local = 388,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 389,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 390,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 391,               /* -Wunused-parameter */
  OPT_Wunused_private = 392,                 /* -Wunused-private */
  OPT_Wunused_result = 393,                  /* -Wunused-result */
  OPT_Wunused_thrown = 394,                  /* -Wunused-thrown */
  OPT_Wunused_value = 395,                   /* -Wunused-value */
  OPT_Wunused_variable = 396,                /* -Wunused-variable */
  OPT_Wuseless_cast = 397,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 398,             /* -Wuseless-type-check */
  OPT_Wvarargs = 399,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 400,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 401,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 402,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 403,            /* -Wvirtual-move-assign */
  OPT_Wvla = 404,                            /* -Wvla */
  OPT_Wvolatile_register_var = 405,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 406,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 407,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 408,  /* -Wzero-as-null-pointer-constant */
  OPT_X = 409,                               /* -X */
  OPT_Xassembler = 410,                      /* -Xassembler */
  OPT_Xlinker = 411,                         /* -Xlinker */
  OPT_Xpreprocessor = 412,                   /* -Xpreprocessor */
  OPT_Z = 413,                               /* -Z */
  OPT_Zall_load = 414,                       /* -Zall_load */
  OPT_Zallowable_client = 415,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 416,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 417,                   /* -Zbind_at_load */
  OPT_Zbundle = 418,                         /* -Zbundle */
  OPT_Zbundle_loader = 419,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 420,                     /* -Zdead_strip */
  OPT_Zdylib_file = 421,                     /* -Zdylib_file */
  OPT_Zdynamic = 422,                        /* -Zdynamic */
  OPT_Zdynamiclib = 423,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 424,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 425,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 426,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 427,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 428,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 429,                     /* -Zimage_base */
  OPT_Zinit = 430,                           /* -Zinit */
  OPT_Zinstall_name = 431,                   /* -Zinstall_name */
  OPT_Zmulti_module = 432,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 433,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 434,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 435,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 436,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 437,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 438,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 439,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 440,                  /* -Zsingle_module */
  OPT_Zumbrella = 441,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 442,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 443,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 444, */                  /* -all_load */
  /* OPT_allowable_client = 445, */          /* -allowable_client */
  OPT_ansi = 446,                            /* -ansi */
  OPT_arch = 447,                            /* -arch */
  /* OPT_arch_errors_fatal = 448, */         /* -arch_errors_fatal */
  OPT_aux_info = 449,                        /* -aux-info */
  /* OPT_aux_info_ = 450, */                 /* -aux-info= */
  OPT_auxbase = 451,                         /* -auxbase */
  OPT_auxbase_strip = 452,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 453, */              /* -bind_at_load */
  /* OPT_bootclasspath = 454, */             /* -bootclasspath */
  /* OPT_bundle = 455, */                    /* -bundle */
  /* OPT_bundle_loader = 456, */             /* -bundle_loader */
  OPT_c = 457,                               /* -c */
  /* OPT_classpath = 458, */                 /* -classpath */
  OPT_client_name = 459,                     /* -client_name */
  OPT_compatibility_version = 460,           /* -compatibility_version */
  OPT_coverage = 461,                        /* -coverage */
  OPT_cpp = 462,                             /* -cpp */
  OPT_cpp_ = 463,                            /* -cpp= */
  OPT_current_version = 464,                 /* -current_version */
  OPT_d = 465,                               /* -d */
  /* OPT_dead_strip = 466, */                /* -dead_strip */
  /* OPT_dependency_file = 467, */           /* -dependency-file */
  OPT_dumpbase = 468,                        /* -dumpbase */
  OPT_dumpdir = 469,                         /* -dumpdir */
  OPT_dumpmachine = 470,                     /* -dumpmachine */
  OPT_dumpspecs = 471,                       /* -dumpspecs */
  OPT_dumpversion = 472,                     /* -dumpversion */
  /* OPT_dylib_file = 473, */                /* -dylib_file */
  OPT_dylinker = 474,                        /* -dylinker */
  OPT_dylinker_install_name = 475,           /* -dylinker_install_name */
  /* OPT_dynamic = 476, */                   /* -dynamic */
  /* OPT_dynamiclib = 477, */                /* -dynamiclib */
  OPT_e = 478,                               /* -e */
  /* OPT_encoding = 479, */                  /* -encoding */
  OPT_export_dynamic = 480,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 481, */     /* -exported_symbols_list */
  OPT_extdirs = 482,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 483, */               /* -fCLASSPATH= */
  OPT_fPIC = 484,                            /* -fPIC */
  OPT_fPIE = 485,                            /* -fPIE */
  OPT_fRTS_ = 486,                           /* -fRTS= */
  OPT_fabi_version_ = 487,                   /* -fabi-version= */
  OPT_faccess_control = 488,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 489,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 490,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 491,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 492,                  /* -falign-commons */
  OPT_falign_functions = 493,                /* -falign-functions */
  OPT_falign_functions_ = 494,               /* -falign-functions= */
  OPT_falign_jumps = 495,                    /* -falign-jumps */
  OPT_falign_jumps_ = 496,                   /* -falign-jumps= */
  OPT_falign_labels = 497,                   /* -falign-labels */
  OPT_falign_labels_ = 498,                  /* -falign-labels= */
  OPT_falign_loops = 499,                    /* -falign-loops */
  OPT_falign_loops_ = 500,                   /* -falign-loops= */
  OPT_fall_intrinsics = 501,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 502, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 503,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 504,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 505, */   /* -falt-external-templates */
  OPT_fapple_kext = 506,                     /* -fapple-kext */
  /* OPT_fargument_alias = 507, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 508, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 509, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 510, */  /* -fargument-noalias-global */
  OPT_fasm = 511,                            /* -fasm */
  OPT_fassert = 512,                         /* -fassert */
  OPT_fassociative_math = 513,               /* -fassociative-math */
  OPT_fassume_compiled = 514,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 515,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 516,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 517,                   /* -fauto-inc-dec */
  OPT_fautomatic = 518,                      /* -fautomatic */
  OPT_faux_classpath = 519,                  /* -faux-classpath */
  OPT_fbackslash = 520,                      /* -fbackslash */
  OPT_fbacktrace = 521,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 522,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 523,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 524,              /* -fbootstrap-classes */
  OPT_fbounds_check = 525,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 526,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 527,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 528,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 529,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 530,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 531,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 532,                        /* -fbuiltin */
  OPT_fbuiltin_ = 533,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 534,                    /* -fcall-saved- */
  OPT_fcall_used_ = 535,                     /* -fcall-used- */
  OPT_fcaller_saves = 536,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 537,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 538,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 539,                /* -fcheck-data-deps */
  OPT_fcheck_new = 540,                      /* -fcheck-new */
  OPT_fcheck_references = 541,               /* -fcheck-references */
  OPT_fcheck_ = 542,                         /* -fcheck= */
  OPT_fclasspath_ = 543,                     /* -fclasspath= */
  OPT_fcoarray_ = 544,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 545,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 546,                         /* -fcommon */
  OPT_fcompare_debug = 547,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 548,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 549,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 550,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 551,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 552,                  /* -fcond-mismatch */
  OPT_fconserve_space = 553,                 /* -fconserve-space */
  OPT_fconserve_stack = 554,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 555,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 556,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 557,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 558,          /* -fconvert=little-endian */
  OPT_fconvert_native = 559,                 /* -fconvert=native */
  OPT_fconvert_swap = 560,                   /* -fconvert=swap */
  OPT_fcprop_registers = 561,                /* -fcprop-registers */
  OPT_fcray_pointer = 562,                   /* -fcray-pointer */
  OPT_fcrossjumping = 563,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 564,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 565, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 566,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 567,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 568,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 569,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 570,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 571,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 572,                       /* -fdbg-cnt= */
  OPT_fdce = 573,                            /* -fdce */
  OPT_fdebug_cpp = 574,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 575,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 576,            /* -fdebug-types-section */
  ...
  OPT_fdiagnostics_show_caret = 587,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 588,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 589,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 590,                /* -fdirectives-only */
  OPT_fdisable_ = 591,                       /* -fdisable- */
  OPT_fdisable_assertions = 592,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 593,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 594,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 595,         /* -fdollars-in-identifiers */
  OPT_fdse = 596,                            /* -fdse */
  OPT_fdump_ = 597,                          /* -fdump- */
  OPT_fdump_ada_spec = 598,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 599,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 600, */                /* -fdump-core */
  OPT_fdump_final_insns = 601,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 602,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 603,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 604,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 605,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 606,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 607,                /* -fdump-parse-tree */
  OPT_fdump_passes = 608,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 609,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 610,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 611,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 612,                 /* -fearly-inlining */
  OPT_felide_constructors = 613,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 614,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 615, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 616,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 617,        /* -femit-class-debug-always */
  OPT_femit_class_file = 618,                /* -femit-class-file */
  OPT_femit_class_files = 619,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 620,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 621,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 622,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 623,                        /* -fenable- */
  OPT_fenable_assertions = 624,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 625,             /* -fenable-assertions= */
  OPT_fencoding_ = 626,                      /* -fencoding= */
  ...
  OPT_fextdirs_ = 634,                       /* -fextdirs= */
  OPT_fextended_identifiers = 635,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 636,                /* -fextern-tls-init */
  OPT_fexternal_blas = 637,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 638, */       /* -fexternal-templates */
  OPT_ff2c = 639,                            /* -ff2c */
  OPT_ffast_math = 640,                      /* -ffast-math */
  OPT_ffat_lto_objects = 641,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 642,                  /* -ffilelist-file */
  ...
  OPT_fforce_classes_archive_check = 651,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 652,              /* -fforward-propagate */
  OPT_ffp_contract_ = 653,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 654,                      /* -ffpe-trap= */
  OPT_ffree_form = 655,                      /* -ffree-form */
  OPT_ffree_line_length_ = 656,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 657,          /* -ffree-line-length-none */
  OPT_ffreestanding = 658,                   /* -ffreestanding */
  OPT_ffriend_injection = 659,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 660,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 661,                   /* -ffunction-cse */
  OPT_ffunction_sections = 662,              /* -ffunction-sections */
  OPT_fgcse = 663,                           /* -fgcse */
  OPT_fgcse_after_reload = 664,              /* -fgcse-after-reload */
  OPT_fgcse_las = 665,                       /* -fgcse-las */
  OPT_fgcse_lm = 666,                        /* -fgcse-lm */
  OPT_fgcse_sm = 667,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 668,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 669,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 670,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 671,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 672,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 673,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 674,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 675,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 676,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 677,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 678,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 679,                       /* -fgraphite */
  OPT_fgraphite_identity = 680,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 681,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 682, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 683, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 684,           /* -fhash-synchronization */
  /* OPT_fhelp = 685, */                     /* -fhelp */
  /* OPT_fhelp_ = 686, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 687,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 688, */                /* -fhonor-std */
  OPT_fhosted = 689,                         /* -fhosted */
  /* OPT_fhuge_objects = 690, */             /* -fhuge-objects */
  OPT_fident = 691,                          /* -fident */
  OPT_fif_conversion = 692,                  /* -fif-conversion */
  OPT_fif_conversion2 = 693,                 /* -fif-conversion2 */
  OPT_filelist = 694,                        /* -filelist */
  OPT_fimplement_inlines = 695,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 696,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 697,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 698,             /* -fimplicit-templates */
  OPT_findirect_classes = 699,               /* -findirect-classes */
  OPT_findirect_dispatch = 700,              /* -findirect-dispatch */
  OPT_findirect_inlining = 701,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 702,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 703,         /* -finhibit-size-directive */
  OPT_finit_character_ = 704,                /* -finit-character= */
  OPT_finit_integer_ = 705,                  /* -finit-integer= */
  OPT_finit_local_zero = 706,                /* -finit-local-zero */
  OPT_finit_logical_ = 707,                  /* -finit-logical= */
  OPT_finit_real_ = 708,                     /* -finit-real= */
  OPT_finline = 709,                         /* -finline */
  OPT_finline_atomics = 710,                 /* -finline-atomics */
  OPT_finline_functions = 711,               /* -finline-functions */
  OPT_finline_functions_called_once = 712,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 713, */            /* -finline-limit- */
  OPT_finline_limit_ = 714,                  /* -finline-limit= */
  OPT_finline_small_functions = 715,         /* -finline-small-functions */
  OPT_finput_charset_ = 716,                 /* -finput-charset= */
  OPT_finstrument_functions = 717,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 718,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 719,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 720,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 721,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 722,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 723,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 724,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 725, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 726,                    /* -fipa-profile */
  OPT_fipa_pta = 727,                        /* -fipa-pta */
  OPT_fipa_pure_const = 728,                 /* -fipa-pure-const */
  OPT_fipa_reference = 729,                  /* -fipa-reference */
  OPT_fipa_sra = 730,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 731, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 732,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 733,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 734,              /* -fira-loop-pressure */
  OPT_fira_region_ = 735,                    /* -fira-region= */
  OPT_fira_share_save_slots = 736,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 737,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 738,                   /* -fira-verbose= */
  OPT_fivopts = 739,                         /* -fivopts */
  OPT_fjni = 740,                            /* -fjni */
  OPT_fjump_tables = 741,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 742,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 743,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 744,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 745, */                /* -flabels-ok */
  /* OPT_flat_namespace = 746, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 747,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 748,             /* -fleading-underscore */
  OPT_floop_block = 749,                     /* -floop-block */
  /* OPT_floop_flatten = 750, */             /* -floop-flatten */
  OPT_floop_interchange = 751,               /* -floop-interchange */
  OPT_floop_nest_optimize = 752,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 753, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 754,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 755,                /* -floop-strip-mine */
  OPT_flto = 756,                            /* -flto */
  OPT_flto_compression_level_ = 757,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 758,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 759,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 760,              /* -flto-partition=max */
  OPT_flto_partition_none = 761,             /* -flto-partition=none */
  OPT_flto_report = 762,                     /* -flto-report */
  OPT_flto_ = 763,                           /* -flto= */
  OPT_fltrans = 764,                         /* -fltrans */
  OPT_fltrans_output_list_ = 765,            /* -fltrans-output-list= */
  OPT_fmain_ = 766,                          /* -fmain= */
  OPT_fmath_errno = 767,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 768,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 769,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 770,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 771,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 772,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 773,                     /* -fmem-report */
  OPT_fmem_report_wpa = 774,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 775,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 776,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 777,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 778,                /* -fmessage-length= */
  OPT_fmodule_private = 779,                 /* -fmodule-private */
  OPT_fmodulo_sched = 780,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 781,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 782,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 783,                  /* -fms-extensions */
  OPT_fmudflap = 784,                        /* -fmudflap */
  OPT_fmudflapir = 785,                      /* -fmudflapir */
  OPT_fmudflapth = 786,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 787, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 788, */                  /* -fnew-abi */
  OPT_fnext_runtime = 789,                   /* -fnext-runtime */
  OPT_fnil_receivers = 790,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 791,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 792,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 793, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 794,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 795,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 796,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 797,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 798,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 799,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 800,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 801,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 802,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 803,             /* -fomit-frame-pointer */
  OPT_fopenmp = 804,                         /* -fopenmp */
  OPT_foperator_names = 805,                 /* -foperator-names */
  OPT_fopt_info = 806,                       /* -fopt-info */
  OPT_fopt_info_ = 807,                      /* -fopt-info- */
  OPT_foptimize_register_move = 808,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 809,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 810,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 811,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 812, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 813, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 814, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 815,              /* -foutput-class-dir= */
  OPT_fpack_derived = 816,                   /* -fpack-derived */
  OPT_fpack_struct = 817,                    /* -fpack-struct */
  OPT_fpack_struct_ = 818,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 819,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 820,              /* -fpcc-struct-return */
  OPT_fpch_deps = 821,                       /* -fpch-deps */
  OPT_fpch_preprocess = 822,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 823,                     /* -fpeel-loops */
  OPT_fpeephole = 824,                       /* -fpeephole */
  OPT_fpeephole2 = 825,                      /* -fpeephole2 */
  OPT_fpermissive = 826,                     /* -fpermissive */
  OPT_fpic = 827,                            /* -fpic */
  OPT_fpie = 828,                            /* -fpie */
  OPT_fplan9_extensions = 829,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 830,                    /* -fplugin-arg- */
  OPT_fplugin_ = 831,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 832,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 833,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 834,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 835,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 836,                   /* -fpreprocessed */
  OPT_fpretty_templates = 837,               /* -fpretty-templates */
  OPT_fprofile = 838,                        /* -fprofile */
  OPT_fprofile_arcs = 839,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 840,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 841,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 842,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 843,              /* -fprofile-generate= */
  OPT_fprofile_report = 844,                 /* -fprofile-report */
  OPT_fprofile_use = 845,                    /* -fprofile-use */
  OPT_fprofile_use_ = 846,                   /* -fprofile-use= */
  OPT_fprofile_values = 847,                 /* -fprofile-values */
  OPT_fprotect_parens = 848,                 /* -fprotect-parens */
  OPT_framework = 849,                       /* -framework */
  OPT_frandom_seed = 850,                    /* -frandom-seed */
  OPT_frandom_seed_ = 851,                   /* -frandom-seed= */
  OPT_frange_check = 852,                    /* -frange-check */
  OPT_freal_4_real_10 = 853,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 854,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 855,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 856,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 857,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 858,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 859,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 860,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 861,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 862,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 863,                /* -frecord-marker=8 */
  OPT_frecursive = 864,                      /* -frecursive */
  OPT_freduced_reflection = 865,             /* -freduced-reflection */
  OPT_free = 866,                            /* -free */
  OPT_freg_struct_return = 867,              /* -freg-struct-return */
  OPT_fregmove = 868,                        /* -fregmove */
  OPT_frename_registers = 869,               /* -frename-registers */
  OPT_freorder_blocks = 870,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 871,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 872,              /* -freorder-functions */
  OPT_frepack_arrays = 873,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 874,           /* -freplace-objc-classes */
  OPT_frepo = 875,                           /* -frepo */
  OPT_frequire_return_statement = 876,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 877,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 878, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 879,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 880,                    /* -fresolution= */
  OPT_frounding_math = 881,                  /* -frounding-math */
  OPT_frtti = 882,                           /* -frtti */
  OPT_fsanitize_address = 883,               /* -fsanitize=address */
  OPT_fsanitize_thread = 884,                /* -fsanitize=thread */
  ...
  OPT_fsingle_precision_constant = 924,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 925,               /* -fsource-filename= */
  OPT_fsource_ = 926,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 927,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 928,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 929,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 930, */                 /* -fsquangle */
  OPT_fstack_arrays = 931,                   /* -fstack-arrays */
  /* OPT_fstack_check = 932, */              /* -fstack-check */
  OPT_fstack_check_ = 933,                   /* -fstack-check= */
  OPT_fstack_limit = 934,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 935,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 936,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 937,                /* -fstack-protector */
  OPT_fstack_protector_all = 938,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 939,                   /* -fstack-reuse= */
  OPT_fstack_usage = 940,                    /* -fstack-usage */
  OPT_fstats = 941,                          /* -fstats */
  OPT_fstore_check = 942,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 943, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 944,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 945,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 946,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 947, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 948,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 949,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 950,                    /* -fsyntax-only */
  OPT_ftabstop_ = 951,                       /* -ftabstop= */
  /* OPT_ftarget_help = 952, */              /* -ftarget-help */
  OPT_ftarget_ = 953,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 954,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 955, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 956,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 957,             /* -fterminated-vtables */
  OPT_ftest_coverage = 958,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 959, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 960,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 961,             /* -fthreadsafe-statics */
  OPT_ftime_report = 962,                    /* -ftime-report */
  OPT_ftls_model_ = 963,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 964,               /* -ftoplevel-reorder */
  OPT_ftracer = 965,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 966,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 967,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 968,                  /* -ftrapping-math */
  OPT_ftrapv = 969,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 970,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 971,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 972,                       /* -ftree-ccp */
  OPT_ftree_ch = 973,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 974,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 975,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 976,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 977,                /* -ftree-copyrename */
  OPT_ftree_cselim = 978,                    /* -ftree-cselim */
  OPT_ftree_dce = 979,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 980,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 981,                       /* -ftree-dse */
  OPT_ftree_forwprop = 982,                  /* -ftree-forwprop */
  OPT_ftree_fre = 983,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 984,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 985,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 986,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 987,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 988,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 989,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 990, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 991,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 992,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 993,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 994,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 995,                   /* -ftree-phiprop */
  OPT_ftree_pre = 996,                       /* -ftree-pre */
  OPT_ftree_pta = 997,                       /* -ftree-pta */
  OPT_ftree_reassoc = 998,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 999, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 1000,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1001,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1002,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1003,                     /* -ftree-slsr */
  OPT_ftree_sra = 1004,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1005, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1006, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1007,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1008,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1009,                      /* -ftree-ter */
  OPT_ftree_vect_loop_version = 1010,        /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1011,                /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 1012,      /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1013,                      /* -ftree-vrp */
  OPT_funderscoring = 1014,                  /* -funderscoring */
  OPT_funit_at_a_time = 1015,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1016,              /* -funroll-all-loops */
  OPT_funroll_loops = 1017,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1018,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1019,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1020,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1021,                 /* -funsigned-char */
  OPT_funswitch_loops = 1022,                /* -funswitch-loops */
  OPT_funwind_tables = 1023,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1024,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1025,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1026,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1027,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1028,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1029,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1030,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1031,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1032,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1033,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1034,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1035,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1036,/* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 1037,               /* -fvect-cost-model */
  OPT_fverbose_asm = 1038,                   /* -fverbose-asm */
  /* OPT_fversion = 1039, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1040,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1041,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1042,                   /* -fvisibility= */
  OPT_fvpt = 1043,                           /* -fvpt */
  /* OPT_fvtable_gc = 1044, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1045, */           /* -fvtable-thunks */
  OPT_fweak = 1046,                          /* -fweak */
  OPT_fweb = 1047,                           /* -fweb */
  OPT_fwhole_file = 1048,                    /* -fwhole-file */
  OPT_fwhole_program = 1049,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1050,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1051,             /* -fworking-directory */
  OPT_fwpa = 1052,                           /* -fwpa */
  OPT_fwrapv = 1053,                         /* -fwrapv */
  /* OPT_fxref = 1054, */                    /* -fxref */
  /* OPT_fzee = 1055, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1056,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1057,                     /* -fzero-link */
  OPT_g = 1058,                              /* -g */
  OPT_gant = 1059,                           /* -gant */
  OPT_gcoff = 1060,                          /* -gcoff */
  OPT_gdwarf_ = 1061,                        /* -gdwarf- */
  OPT_gen_decls = 1062,                      /* -gen-decls */
  OPT_gfull = 1063,                          /* -gfull */
  OPT_ggdb = 1064,                           /* -ggdb */
  OPT_gnat = 1065,                           /* -gnat */
  OPT_gnatO = 1066,                          /* -gnatO */
  OPT_gno_pubnames = 1067,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1068,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1069,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1070,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1071,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1072,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1073,                   /* -gsplit-dwarf */
  OPT_gstabs = 1074,                         /* -gstabs */
  OPT_gstabs_ = 1075,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1076,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1077,                        /* -gtoggle */
  OPT_gused = 1078,                          /* -gused */
  OPT_gvms = 1079,                           /* -gvms */
  OPT_gxcoff = 1080,                         /* -gxcoff */
  OPT_gxcoff_ = 1081,                        /* -gxcoff+ */
  OPT_h = 1082,                              /* -h */
  OPT_headerpad_max_install_names = 1083,    /* -headerpad_max_install_names */
  OPT_idirafter = 1084,                      /* -idirafter */
  OPT_iframework = 1085,                     /* -iframework */
  OPT_imacros = 1086,                        /* -imacros */
  /* OPT_image_base = 1087, */               /* -image_base */
  OPT_imultiarch = 1088,                     /* -imultiarch */
  OPT_imultilib = 1089,                      /* -imultilib */
  OPT_include = 1090,                        /* -include */
  /* OPT_init = 1091, */                     /* -init */
  /* OPT_install_name = 1092, */             /* -install_name */
  OPT_iplugindir_ = 1093,                    /* -iplugindir= */
  OPT_iprefix = 1094,                        /* -iprefix */
  OPT_iquote = 1095,                         /* -iquote */
  OPT_isysroot = 1096,                       /* -isysroot */
  OPT_isystem = 1097,                        /* -isystem */
  OPT_iwithprefix = 1098,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1099,              /* -iwithprefixbefore */
  OPT_k8 = 1100,                             /* -k8 */
  OPT_keep_private_externs = 1101,           /* -keep_private_externs */
  OPT_l = 1102,                              /* -l */
  OPT_lang_asm = 1103,                       /* -lang-asm */
  OPT_m128bit_long_double = 1104,            /* -m128bit-long-double */
  OPT_m32 = 1105,                            /* -m32 */
  OPT_m3dnow = 1106,                         /* -m3dnow */
  OPT_m3dnowa = 1107,                        /* -m3dnowa */
  OPT_m64 = 1108,                            /* -m64 */
  OPT_m80387 = 1109,                         /* -m80387 */
  OPT_m8bit_idiv = 1110,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1111,             /* -m96bit-long-double */
  OPT_mabi_ = 1112,                          /* -mabi= */
  OPT_mabm = 1113,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1114,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1115,                 /* -maddress-mode= */
  OPT_madx = 1116,                           /* -madx */
  OPT_maes = 1117,                           /* -maes */
  OPT_malign_double = 1118,                  /* -malign-double */
  OPT_malign_functions_ = 1119,              /* -malign-functions= */
  OPT_malign_jumps_ = 1120,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1121,                  /* -malign-loops= */
  OPT_malign_stringops = 1122,               /* -malign-stringops */
  OPT_march_ = 1123,                         /* -march= */
  OPT_masm_ = 1124,                          /* -masm= */
  OPT_matt_stubs = 1125,                     /* -matt-stubs */
  OPT_mavx = 1126,                           /* -mavx */
  OPT_mavx2 = 1127,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1128,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1129,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1130,                           /* -mbmi */
  OPT_mbmi2 = 1131,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1132,                  /* -mbranch-cost= */
  OPT_mcld = 1133,                           /* -mcld */
  OPT_mcmodel_ = 1134,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1135,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1136, */                    /* -mcpu= */
  OPT_mcrc32 = 1137,                         /* -mcrc32 */
  OPT_mcx16 = 1138,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1139,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1140,                /* -mdynamic-no-pic */
  OPT_mf16c = 1141,                          /* -mf16c */
  OPT_mfancy_math_387 = 1142,                /* -mfancy-math-387 */
  OPT_mfentry = 1143,                        /* -mfentry */
  OPT_mfix_and_continue = 1144,              /* -mfix-and-continue */
  OPT_mfma = 1145,                           /* -mfma */
  OPT_mfma4 = 1146,                          /* -mfma4 */
  OPT_mforce_drap = 1147,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1148,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1149,                       /* -mfpmath= */
  OPT_mfsgsbase = 1150,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1151, */              /* -mfused-madd */
  OPT_mfxsr = 1152,                          /* -mfxsr */
  OPT_mhard_float = 1153,                    /* -mhard-float */
  OPT_mhle = 1154,                           /* -mhle */
  OPT_mieee_fp = 1155,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1156,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1157,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1158,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1159, */            /* -mintel-syntax */
  OPT_mkernel = 1160,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1161,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1162,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1163,                /* -mlong-double-80 */
  OPT_mlwp = 1164,                           /* -mlwp */
  OPT_mlzcnt = 1165,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1166,           /* -mmacosx-version-min= */
  OPT_mmmx = 1167,                           /* -mmmx */
  OPT_mmovbe = 1168,                         /* -mmovbe */
  OPT_mms_bitfields = 1169,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1170,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1171,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1172,                  /* -mno-push-args */
  OPT_mno_red_zone = 1173,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1174,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1175,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1176,                 /* -mone-byte-bool */
  OPT_mpc32 = 1177,                          /* -mpc32 */
  OPT_mpc64 = 1178,                          /* -mpc64 */
  OPT_mpc80 = 1179,                          /* -mpc80 */
  OPT_mpclmul = 1180,                        /* -mpclmul */
  OPT_mpopcnt = 1181,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1182,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1183,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1184,                        /* -mprfchw */
  OPT_mpush_args = 1185,                     /* -mpush-args */
  OPT_mrdrnd = 1186,                         /* -mrdrnd */
  OPT_mrdseed = 1187,                        /* -mrdseed */
  OPT_mrecip = 1188,                         /* -mrecip */
  OPT_mrecip_ = 1189,                        /* -mrecip= */
  OPT_mred_zone = 1190,                      /* -mred-zone */
  OPT_mregparm_ = 1191,                      /* -mregparm= */
  OPT_mrtd = 1192,                           /* -mrtd */
  OPT_mrtm = 1193,                           /* -mrtm */
  OPT_msahf = 1194,                          /* -msahf */
  OPT_msoft_float = 1195,                    /* -msoft-float */
  OPT_msse = 1196,                           /* -msse */
  OPT_msse2 = 1197,                          /* -msse2 */
  OPT_msse2avx = 1198,                       /* -msse2avx */
  OPT_msse3 = 1199,                          /* -msse3 */
  OPT_msse4 = 1200,                          /* -msse4 */
  OPT_msse4_1 = 1201,                        /* -msse4.1 */
  OPT_msse4_2 = 1202,                        /* -msse4.2 */
  OPT_msse4a = 1203,                         /* -msse4a */
  /* OPT_msse5 = 1204, */                    /* -msse5 */
  OPT_msseregparm = 1205,                    /* -msseregparm */
  OPT_mssse3 = 1206,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1207,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1208,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1209,            /* -mstringop-strategy= */
  OPT_mtbm = 1210,                           /* -mtbm */
  OPT_mtls_dialect_ = 1211,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1212,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1213,                         /* -mtune= */
  /* OPT_multi_module = 1214, */             /* -multi_module */
  /* OPT_multiply_defined = 1215, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1216, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1217,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1218,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1219,                    /* -mvzeroupper */
  OPT_mx32 = 1220,                           /* -mx32 */
  OPT_mxop = 1221,                           /* -mxop */
  OPT_mxsave = 1222,                         /* -mxsave */
  OPT_mxsaveopt = 1223,                      /* -mxsaveopt */
  OPT_n = 1224,                              /* -n */
  OPT_no_canonical_prefixes = 1225,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1226,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1227, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1228,                          /* -nocpp */
  OPT_nodefaultlibs = 1229,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1230,                /* -nofixprebinding */
  OPT_nomultidefs = 1231,                    /* -nomultidefs */
  OPT_noprebind = 1232,                      /* -noprebind */
  OPT_noseglinkedit = 1233,                  /* -noseglinkedit */
  OPT_nostartfiles = 1234,                   /* -nostartfiles */
  OPT_nostdinc = 1235,                       /* -nostdinc */
  OPT_nostdinc__ = 1236,                     /* -nostdinc++ */
  OPT_nostdlib = 1237,                       /* -nostdlib */
  OPT_o = 1238,                              /* -o */
  OPT_object = 1239,                         /* -object */
  OPT_p = 1240,                              /* -p */
  OPT_pagezero_size = 1241,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1242,                /* -pass-exit-codes */
  /* OPT_pedantic = 1243, */                 /* -pedantic */
  OPT_pedantic_errors = 1244,                /* -pedantic-errors */
  OPT_pg = 1245,                             /* -pg */
  OPT_pie = 1246,                            /* -pie */
  OPT_pipe = 1247,                           /* -pipe */
  OPT_prebind = 1248,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1249,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1250,                        /* -preload */
  ...
  OPT_private_bundle = 1262,                 /* -private_bundle */
  OPT_pthread = 1263,                        /* -pthread */
  OPT_quiet = 1264,                          /* -quiet */
  OPT_r = 1265,                              /* -r */
  OPT_read_only_relocs = 1266,               /* -read_only_relocs */
  OPT_remap = 1267,                          /* -remap */
  OPT_s = 1268,                              /* -s */
  OPT_s_bc_abi = 1269,                       /* -s-bc-abi */
  OPT_save_temps = 1270,                     /* -save-temps */
  OPT_save_temps_ = 1271,                    /* -save-temps= */
  OPT_sectalign = 1272,                      /* -sectalign */
  OPT_sectcreate = 1273,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1274,              /* -sectobjectsymbols */
  OPT_sectorder = 1275,                      /* -sectorder */
  OPT_seg1addr = 1276,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1277, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1278, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1279, */                  /* -segaddr */
  OPT_segcreate = 1280,                      /* -segcreate */
  OPT_seglinkedit = 1281,                    /* -seglinkedit */
  OPT_segprot = 1282,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1283, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1284, */     /* -segs_read_write_addr */
  OPT_shared = 1285,                         /* -shared */
  OPT_shared_libgcc = 1286,                  /* -shared-libgcc */
  /* OPT_single_module = 1287, */            /* -single_module */
  /* OPT_specs = 1288, */                    /* -specs */
  OPT_specs_ = 1289,                         /* -specs= */
  OPT_static = 1290,                         /* -static */
  OPT_static_libasan = 1291,                 /* -static-libasan */
  OPT_static_libgcc = 1292,                  /* -static-libgcc */
  OPT_static_libgcj = 1293,                  /* -static-libgcj */
  OPT_static_libgfortran = 1294,             /* -static-libgfortran */
  OPT_static_libgo = 1295,                   /* -static-libgo */
  OPT_static_libstdc__ = 1296,               /* -static-libstdc++ */
  OPT_static_libtsan = 1297,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1298, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1299, */                /* -std=c++0x */
  OPT_std_c__11 = 1300,                      /* -std=c++11 */
  OPT_std_c__1y = 1301,                      /* -std=c++1y */
  OPT_std_c__98 = 1302,                      /* -std=c++98 */
  OPT_std_c11 = 1303,                        /* -std=c11 */
  /* OPT_std_c1x = 1304, */                  /* -std=c1x */
  /* OPT_std_c89 = 1305, */                  /* -std=c89 */
  OPT_std_c90 = 1306,                        /* -std=c90 */
  OPT_std_c99 = 1307,                        /* -std=c99 */
  /* OPT_std_c9x = 1308, */                  /* -std=c9x */
  OPT_std_f2003 = 1309,                      /* -std=f2003 */
  OPT_std_f2008 = 1310,                      /* -std=f2008 */
  OPT_std_f2008ts = 1311,                    /* -std=f2008ts */
  OPT_std_f95 = 1312,                        /* -std=f95 */
  OPT_std_gnu = 1313,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1314, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1315, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1316,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1317,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1318,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1319,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1320, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1321, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1322,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1323,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1324, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1325, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1326,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1327, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1328, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1329, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1330,                     /* -std=legacy */
  OPT_sub_library = 1331,                    /* -sub_library */
  OPT_sub_umbrella = 1332,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1340,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1341,       /* -twolevel_namespace_hints */
  OPT_u = 1342,                              /* -u */
  /* OPT_umbrella = 1343, */                 /* -umbrella */
  OPT_undef = 1344,                          /* -undef */
  OPT_undefined = 1345,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1346, */  /* -unexported_symbols_list */
  OPT_v = 1347,                              /* -v */
  OPT_version = 1348,                        /* -version */
  OPT_w = 1349,                              /* -w */
  /* OPT_weak_reference_mismatches = 1350, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1351,                    /* -whatsloaded */
  OPT_whyload = 1352,                        /* -whyload */
  OPT_wrapper = 1353,                        /* -wrapper */
  OPT_x = 1354,                              /* -x */
  OPT_y = 1355,                              /* -y */
  OPT_z = 1356,                              /* -z */
  N_OPTS,
