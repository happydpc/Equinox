...
C **********************************
      PARAMETER(MAXSIG=200000,MAXCYC=MAXSIG/2,NBPAL=20,NBVOLM=100,
...
C           NBVOL   NOMBRE DE VOLS
C ********************************
      PARAMETER(MAXSIG=200000,NBPAL=20,NBVOLM=100)
C
      CHARACTER*80 NOMPB
      CHARACTER*80  MESSAG
...
C           NBSEQ   LONGUEUR DE LA SEQUENCE
C *****************************************
      PARAMETER(MAXSIG=200000,NBVOLM=100)
C
      CHARACTER*80 NOMPB
      CHARACTER*1   BLANC(5)
...
C *********************************************
      PARAMETER(MAXSIG=200000,MAXCYC=MAXSIG/2)
C
      CHARACTER*80 NOMPB
