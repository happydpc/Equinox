...
/**
 * Class for save typical flight occurrence plot task.
 *
 * @author Murat Artim
 * @date 25 Jul 2016
 * @time 16:48:45
 */
public class SaveFlightOccurrencePlot extends TemporaryFileCreatingTask<Void> implements ShortRunningTask, PostProcessingTask {

	/** Stress sequence. */
	private final StressSequence sequence_;

	/**
	 * Creates save typical flight occurrence plot task.
	 *
	 * @param sequence
	 *            Stress sequence.
	 */
	public SaveFlightOccurrencePlot(StressSequence sequence) {
		sequence_ = sequence;
	}
	...
	public String getTaskTitle() {
		return "Save typical flight occurrence plot for '" + sequence_.getName() + "'";
	}
