...
public class SaveLoadcaseDamageContributionPlot extends TemporaryFileCreatingTask<Path> implements ShortRunningTask, SingleInputTask<LoadcaseDamageContributions>, AutomaticTaskOwner<Path> {
	 ...
	 */
	public SaveLoadcaseDamageContributionPlot(LoadcaseDamageContributions contributions, boolean saveToDatabase, Path outputFile) {
	...
	@Override
	public void setAutomaticInput(LoadcaseDamageContributions input) {
	...
	public String getTaskTitle() {
		return "Save loadcase damage contributions plot";
	}
