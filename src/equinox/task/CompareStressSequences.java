...
public class CompareStressSequences extends InternalEquinoxTask<CategoryDataset> implements ShortRunningTask, MultipleInputTask<StressSequence>, AutomaticTaskOwner<Pair<CategoryDataset, StatisticsPlotAttributes>> {
	...
	@Override
	synchronized public void addAutomaticInput(AutomaticTaskOwner<StressSequence> task, StressSequence input, boolean executeInParallel) {
		automaticInputAdded(task, input, executeInParallel, stressSequences_, inputThreshold_);
	}

	@Override
	synchronized public void inputFailed(AutomaticTaskOwner<StressSequence> task, boolean executeInParallel) {
