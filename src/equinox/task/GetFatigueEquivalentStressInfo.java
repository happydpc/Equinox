...
/**
 * Class for getting fatigue equivalent stress info.
 *
 * @author Murat Artim
 * @date Jul 7, 2014
 * @time 2:57:21 PM
 */
public class GetFatigueEquivalentStressInfo extends InternalEquinoxTask<ArrayList<TreeItem<TableItem>>> implements ShortRunningTask {

	/** Fatigue equivalent stress item. */
	private final FatigueEquivalentStress equivalentStress_;
	 ...
	 *            Fatigue equivalent stress item.
	 */
	public GetFatigueEquivalentStressInfo(FatigueEquivalentStress equivalentStress) {
	...
	protected ArrayList<TreeItem<TableItem>> call() throws Exception {
		...
		try (Connection connection = Equinox.DBC_POOL.getConnection()) {
			...
			try (Statement statement = connection.createStatement()) {
				...
				String sql = "select * from fatigue_equivalent_stresses where id = " + equivalentStress_.getID();
