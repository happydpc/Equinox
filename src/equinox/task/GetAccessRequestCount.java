 ...
 * @time 20:37:40
 */
public class GetAccessRequestCount extends InternalEquinoxTask<GetAccessRequestCountResponse> implements ShortRunningTask, DatabaseQueryListenerTask {
	...
	public String getTaskTitle() {
		return "Get access request count";
	}
	...
	@Override
	protected GetAccessRequestCountResponse call() throws Exception {

		// progress info
		updateMessage("Getting access request count...");
		...
		try {
			...
			GetAccessRequestCountRequest request = new GetAccessRequestCountRequest();
			...
			// succeeded
			else if (message instanceof GetAccessRequestCountResponse)
				return (GetAccessRequestCountResponse) message;
		...
		// exception occurred
			...
			Equinox.LOGGER.log(Level.WARNING, "Access request count request has failed.", e);
			return null;
		}
	...
	protected void succeeded() {
		...
		try {
			...
			panel.setAccessRequestCount(get());
		}
