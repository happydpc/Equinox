...
public class OpenWorkspace extends InternalEquinoxTask<Void> {
	...
	protected void succeeded() {
		...
		// at startup
		if (introPanel_ != null) {
			taskPanel_.getOwner().runTasksSequentially(introPanel_.addTask(new SaveWorkspacePaths()), introPanel_.addTask(new UpdateWorkspace()), introPanel_.addTask(new LoadUserAuthentication()), introPanel_.addTask(new GetServerConnectionInfo()),
					introPanel_.addTask(new LoadAllFiles(introPanel_)));
		}
