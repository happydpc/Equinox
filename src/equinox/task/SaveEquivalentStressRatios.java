 ...
 * @time 2:10:09 PM
 */
public class SaveEquivalentStressRatios extends InternalEquinoxTask<Path> implements LongRunningTask, SavableTask, MultipleInputTask<SpectrumItem>, AutomaticTaskOwner<Path> {
