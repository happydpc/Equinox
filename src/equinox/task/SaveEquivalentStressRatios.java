 ...
 * @time 2:10:09 PM
 */
public class SaveEquivalentStressRatios extends InternalEquinoxTask<Void> implements LongRunningTask, SavableTask {
	 ...
	 *            Basis mission.
	 */
	public SaveEquivalentStressRatios(ArrayList<SpectrumItem> stresses, BooleanProperty[] options, File output, String basisMission) {
		stresses_ = stresses;
		options_ = options;
		output_ = output;
