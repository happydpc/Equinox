 ...
 * @time 19:06:17
 */
public class SaveMissionParameterPlot extends InternalEquinoxTask<Path> implements ShortRunningTask, SingleInputTask<Pair<XYSeriesCollection, MissionParameterPlotAttributes>>, AutomaticTaskOwner<Path> {
