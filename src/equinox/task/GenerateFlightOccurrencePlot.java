 ...
 * @time 16:49:23
 */
public class GenerateFlightOccurrencePlot extends TemporaryFileCreatingTask<Void> implements LongRunningTask {
	 ...
	 *            True to plot after generation.
	 */
	public GenerateFlightOccurrencePlot(SpectrumItem eqStress, boolean plot) {
		eqStress_ = eqStress;
		plot_ = plot;
	}
	...
	private Path plotOccurrences(Statement statement) throws Exception {
		...
		Path output = getWorkingDirectory().resolve("typicalFlightOccurrences.png");
