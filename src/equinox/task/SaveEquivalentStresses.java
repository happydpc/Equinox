 ...
 * @time 1:53:12 PM
 */
public class SaveEquivalentStresses extends InternalEquinoxTask<Path> implements LongRunningTask, SavableTask, MultipleInputTask<SpectrumItem>, AutomaticTaskOwner<Path> {
