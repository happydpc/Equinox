...
/**
 * Class for serializable form of save A/C equivalent stress ratios task.
 *
 * @author Murat Artim
 * @date Oct 13, 2015
 * @time 1:46:19 PM
 */
public class SerializableSaveAircraftEquivalentStressRatios implements SerializableTask {
	 ...
	 *            Basis mission.
	 */
	public SerializableSaveAircraftEquivalentStressRatios(AircraftFatigueEquivalentStress eqStress, BooleanProperty[] options, File output, String basisMission) {
	...
	@Override
	public SaveAircraftEquivalentStressRatios getTask(TreeItem<String> fileTreeRoot) {
		...
		return new SaveAircraftEquivalentStressRatios((AircraftFatigueEquivalentStress) result[0], options, output_, basisMission_);
	}
}
