 ...
 * @time 3:29:54 PM
 */
public class GenerateLongestFlightPlot extends TemporaryFileCreatingTask<Void> implements LongRunningTask {
	 ...
	 *            True to plot after generation.
	 */
	public GenerateLongestFlightPlot(SpectrumItem eqStress, boolean plot) {
		eqStress_ = eqStress;
		plot_ = plot;
	}
