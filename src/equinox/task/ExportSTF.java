 ...
 * @time 1:10:31 PM
 */
public class ExportSTF extends TemporaryFileCreatingTask<Path> implements LongRunningTask, SingleInputTask<Triple<STFFile, String[], HashMap<PilotPointImageType, Image>>>, AutomaticTaskOwner<Path> {
