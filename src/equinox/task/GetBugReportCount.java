 ...
 * @time 20:31:30
 */
public class GetBugReportCount extends InternalEquinoxTask<GetBugReportCountResponse> implements ShortRunningTask, DatabaseQueryListenerTask {
	...
	@Override
	protected GetBugReportCountResponse call() throws Exception {

		// progress info
		updateMessage("Getting bug report count...");
		...
		try {
			...
			GetBugReportCountRequest request = new GetBugReportCountRequest();
			...
			// succeeded
			else if (message instanceof GetBugReportCountResponse)
				return (GetBugReportCountResponse) message;
		...
		// exception occurred
			...
			Equinox.LOGGER.log(Level.WARNING, "Bug report count request has failed.", e);
			return null;
		}
