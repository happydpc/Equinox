 ...
 * @time 9:41:48 AM
 */
public class GenerateStressRatiosWithMissionParameters extends InternalEquinoxTask<XYSeriesCollection> implements ShortRunningTask, MultipleInputTask<SpectrumItem>, ParameterizedTaskOwner<Pair<XYSeriesCollection, MissionParameterPlotAttributes>> {
	...
	protected void succeeded() {
		...
		try {
			...
			String ratioType = getRatioType(stresses_.get(0));
