...
/**
 * Class for plot longest typical flight from fast equivalent stress task.
 *
 * @author Murat Artim
 * @date Jul 8, 2016
 * @time 3:24:19 PM
 */
public class PlotFastLongestFlight extends InternalEquinoxTask<Image> implements ShortRunningTask {

	/** Equivalent stress. */
	private final SpectrumItem eqStress_;

	/**
	 * Creates plot longest typical flight from fast equivalent stress task.
	 *
	 * @param eqStress
	 *            Equivalent stress.
	 */
	public PlotFastLongestFlight(SpectrumItem eqStress) {
		eqStress_ = eqStress;
	}
	...
	public String getTaskTitle() {
		return "Plot longest typical flight";
	}
	...
	protected Image call() throws Exception {
		...
		updateTitle("Plotting longest typical flight...");
	...
	protected void succeeded() {
		...
		try {
			...
			if (image == null) {
				...
				String title = "Generate Longest Typical Flight";
				String message = "Longest typical flight plot is not available. Do you want to generate the plot?";
