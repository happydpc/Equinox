...
import equinox.dataServer.remote.message.GetUserLocationsRequest;
...
/**
 * Class for get user locations task.
 *
 * @author Murat Artim
 * @date 28 Jul 2018
 * @time 20:17:32
 */
public class GetUserLocations extends InternalEquinoxTask<GetUserLocationsResponse> implements ShortRunningTask, DatabaseQueryListenerTask {
	...
	@Override
	protected GetUserLocationsResponse call() throws Exception {

		// progress info
		updateMessage("Getting user locations...");
		...
		try {
			...
			GetUserLocationsRequest request = new GetUserLocationsRequest();
			...
			// succeeded
			else if (message instanceof GetUserLocationsResponse)
				return (GetUserLocationsResponse) message;
		...
		// exception occurred
			...
			Equinox.LOGGER.log(Level.WARNING, "User locations request has failed.", e);
			return null;
		}
