...
public class Settings {
	...
	/** Setting index. */
	public static final int NOTIFY_EQUINOX_UPDATES = 0, NOTIFY_PLUGIN_UPDATES = 1, NOTIFY_MATERIAL_UPDATES = 2, LIKES = 3, NETWORK_HOSTNAME = 4, NETWORK_PORT = 5, WEB_HOSTNAME = 6, WEB_PORT = 7, NOTIFY_MESSAGES = 8, NOTIFY_FILES = 9, NOTIFY_ERRORS = 10, NOTIFY_WARNINGS = 11, NOTIFY_INFO = 12,
			NOTIFY_QUEUED = 13, NOTIFY_SUBMITTED = 14, NOTIFY_SUCCEEDED = 15, USE_SYSTEMTRAY = 16, ANALYSIS_ENGINE = 17, ISAMI_SUB_VERSION = 18, FALLBACK_TO_INBUILT = 19, APPLY_COMPRESSION = 20, NOTIFY_SAVED = 21, NOTIFY_SCHEDULED = 22, SHOW_NOTIFY_FROM_BOTTOM = 23, KEEP_ANALYSIS_OUTPUTS = 24,
			DETAILED_ANALYSIS = 25, SHOW_NEWSFEED = 26, ISAMI_VERSION = 27, FILER_USERNAME = 28, FILER_HOSTNAME = 29, FILER_PORT = 30, FILER_PASSWORD = 31, FILER_ROOT_PATH = 32, WEB_PATH = 33;
