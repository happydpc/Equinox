...
/**
 * Class for external linear equivalent stress.
 *
 * @author Murat Artim
 * @date Mar 11, 2015
 * @time 10:43:03 AM
 */
public class ExternalLinearEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates external linear equivalent stress item.
	 *
	 * @param name
	 ...
	 *            Material name.
	 */
	public ExternalLinearEquivalentStress(String name, int id, double omissionLevel, String materialName) {
