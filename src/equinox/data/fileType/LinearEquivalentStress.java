...
/**
 * Class for linear propagation equivalent stress item.
 *
 * @author Murat Artim
 * @date Jul 7, 2014
 * @time 11:28:16 AM
 */
public class LinearEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates linear propagation equivalent stress item.
	 *
	 * @param name
	 *            Name of linear propagation equivalent stress.
	 * @param id
	 *            ID of item.
	 * @param omissionLevel
	 ...
	 *            Material name.
	 */
	public LinearEquivalentStress(String name, int id, double omissionLevel, String materialName) {
