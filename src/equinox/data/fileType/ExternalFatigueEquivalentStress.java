...
/**
 * Class for external fatigue equivalent stress.
 *
 * @author Murat Artim
 * @date Mar 11, 2015
 * @time 10:43:03 AM
 */
public class ExternalFatigueEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates external fatigue equivalent stress item.
	 *
	 * @param name
	 ...
	 *            Material name.
	 */
	public ExternalFatigueEquivalentStress(String name, int id, double omissionLevel, String materialName) {
