...
/**
 * Class for fatigue equivalent stress item.
 *
 * @author Murat Artim
 * @date Jul 7, 2014
 * @time 11:28:16 AM
 */
public class FatigueEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates fatigue equivalent stress item.
	 *
	 * @param name
	 ...
	 *            Material name.
	 */
	public FatigueEquivalentStress(String name, int id, double omissionLevel, String materialName) {
