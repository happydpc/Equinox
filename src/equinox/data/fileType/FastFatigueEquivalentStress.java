...
/**
 * Class for fast fatigue equivalent stress.
 *
 * @author Murat Artim
 * @date Jun 14, 2016
 * @time 3:16:10 PM
 */
public class FastFatigueEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates fast fatigue equivalent stress item.
	 *
	 * @param name
	 ...
	 *            Material name.
	 */
	public FastFatigueEquivalentStress(String name, int id, double omissionLevel, String materialName) {
