...
/**
 * Class for A/C model preffas equivalent stress.
 *
 * @author Murat Artim
 * @date May 6, 2016
 * @time 11:08:49 PM
 */
public class AircraftPreffasEquivalentStress extends SpectrumItem {

	/**
	 * Creates A/C model preffas equivalent stress item.
	 *
	 * @param id
	 *            A/C model preffas equivalent stress ID.
	 * @param name
	 *            A/C model preffas equivalent stress name.
	 */
	public AircraftPreffasEquivalentStress(int id, String name) {
