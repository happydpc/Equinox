...
/**
 * Class for fast Preffas equivalent stress.
 *
 * @author Murat Artim
 * @date Jun 14, 2016
 * @time 8:18:39 PM
 */
public class FastPreffasEquivalentStress extends SpectrumItem {
	...
	/**
	 * Creates fast Preffas equivalent stress item.
	 *
	 * @param name
	 ...
	 *            Material name.
	 */
	public FastPreffasEquivalentStress(String name, int id, double omissionLevel, String materialName) {
