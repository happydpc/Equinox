...
/**
 * Class for Preffas material table item.
 *
 * @author Murat Artim
 * @date Dec 7, 2015
 * @time 12:36:04 PM
 */
public class PreffasMaterialItem {
	...
	/**
	 * Creates Preffas material item.
	 *
	 * @param id
	 *            Material ID.
	 */
	public PreffasMaterialItem(int id) {
		id_ = id;
	}
	...
	/**
	 * Creates and returns Preffas material to be used for analysis.
	 *
	 * @return Preffas material to be used for analysis.
	 */
	public PreffasMaterial getMaterial() {
		PreffasMaterial material = new PreffasMaterial(id_);
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(23, 49).append(id_).toHashCode();
	}

	@Override
	public boolean equals(Object o) {
		if (!(o instanceof PreffasMaterialItem))
			return false;
		if (o == this)
			return true;
		PreffasMaterialItem item = (PreffasMaterialItem) o;
