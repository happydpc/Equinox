...
/**
 * Class for plot A/C life factors input.
 *
 * @author Murat Artim
 * @date Oct 4, 2015
 * @time 7:55:17 PM
 */
public class PlotAircraftLifeFactorsInput {
	...
	/**
	 * Creates plot A/C life factors input.
	 *
	 * @param stress
	 *            A/C equivalent stress.
	 * @param elementType
	 ...
	 *            Plot contour option.
	 */
	public PlotAircraftLifeFactorsInput(AircraftFatigueEquivalentStress stress, ElementTypeForStress elementType, LifeFactorType factorType, String mission,
			String basisMission, int beamExtrusion, int rodExtrusion, int opacity, boolean outlines, PlotContour contour) {
		stress_ = stress;
