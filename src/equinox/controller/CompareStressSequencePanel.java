...
public class CompareStressSequencePanel implements InternalInputSubPanel {
	...
	@FXML
	private ChoiceBox<ComparisonCriteria> criteria_;
	...
	private void onOkClicked() {
		...
		for (TreeItem<String> item : owner_.getSelectedFiles()) {
			input.addStressSequence((StressSequence) item);
		}

		// create and start comparison task
		owner_.getOwner().getActiveTasksPanel().runTaskInParallel(new CompareStressSequences(input));
	}
