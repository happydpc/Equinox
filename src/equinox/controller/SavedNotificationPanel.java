...
/**
 * Class for saved notification panel controller.
 *
 * @author Murat Artim
 * @date Dec 12, 2014
 * @time 9:31:45 AM
 */
public class SavedNotificationPanel implements Initializable {
	...
	private void onButtonClicked() {
		mainScreen_.getMenuBarPanel().showSavedTasks();
	...
	public static VBox load(MainScreen mainScreen, String message) {
		...
		try {
			...
			// load fxml file
			FXMLLoader fxmlLoader = new FXMLLoader(EquinoxTheme.getFXMLResource("SavedNotificationPanel.fxml"));
			fxmlLoader.load();

			// get controller
			SavedNotificationPanel controller = (SavedNotificationPanel) fxmlLoader.getController();
