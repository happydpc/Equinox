...
/**
 * Class for queued notification panel controller.
 *
 * @author Murat Artim
 * @date Dec 12, 2014
 * @time 9:31:45 AM
 */
public class QueuedNotificationPanel implements Initializable {
	...
	private void onButtonClicked() {
		mainScreen_.getMenuBarPanel().showQueuedTasks();
	...
	public static VBox load(MainScreen mainScreen, String message) {
		...
		try {
			...
			// load fxml file
			FXMLLoader fxmlLoader = new FXMLLoader(EquinoxTheme.getFXMLResource("QueuedNotificationPanel.fxml"));
			fxmlLoader.load();

			// get controller
			QueuedNotificationPanel controller = (QueuedNotificationPanel) fxmlLoader.getController();
