...
/**
 * Class for task submitted notification panel.
 *
 * @author Murat Artim
 * @date Dec 11, 2014
 * @time 6:33:30 PM
 */
public class SubmittedNotificationPanel implements Initializable {
	...
	private void onButtonClicked() {
		mainScreen_.getMenuBarPanel().showActiveTasks();
	...
	public static VBox load(MainScreen mainScreen, String message) {
		...
		try {
			...
			// load fxml file
			FXMLLoader fxmlLoader = new FXMLLoader(EquinoxTheme.getFXMLResource("SubmittedNotificationPanel.fxml"));
			fxmlLoader.load();

			// get controller
			SubmittedNotificationPanel controller = (SubmittedNotificationPanel) fxmlLoader.getController();
