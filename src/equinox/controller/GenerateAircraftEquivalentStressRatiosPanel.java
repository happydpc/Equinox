...
import equinox.task.GenerateAircraftEquivalentStressRatios;
...
/**
 * Class for generate A/C model equivalent stress ratios panel controller.
 *
 * @author Murat Artim
 * @date Sep 23, 2015
 * @time 11:13:27 AM
 */
public class GenerateAircraftEquivalentStressRatiosPanel implements InternalInputSubPanel, ElementGroupsRequestingPanel, MissionRequestingPanel {
	...
	public String getHeader() {
		return "Generate Eq. Stress Ratios";
	}
	...
	private void onOkClicked() {
		...
		// create input
		CompareAircraftEquivalentStressRatiosInput input = new CompareAircraftEquivalentStressRatiosInput(eqStress, ratioType, elementType, mission);
		...
		// get task manager
		ActiveTasksPanel tm = owner_.getOwner().getActiveTasksPanel();
		tm.runTaskInParallel(new GenerateAircraftEquivalentStressRatios(input));
	}
	...
	private void onHelpClicked() {
		owner_.getOwner().showHelp("How to generate aircraft model equivalent stress ratios", null);
	}
	 ...
	 */
	public static GenerateAircraftEquivalentStressRatiosPanel load(InputPanel owner) {

		try {

			// load fxml file
			FXMLLoader fxmlLoader = new FXMLLoader(EquinoxTheme.getFXMLResource("GenerateAircraftEquivalentStressRatiosPanel.fxml"));
			...
			// get controller
			GenerateAircraftEquivalentStressRatiosPanel controller = (GenerateAircraftEquivalentStressRatiosPanel) fxmlLoader.getController();
