...
/**
 * Class for info notification panel controller.
 *
 * @author Murat Artim
 * @date Dec 12, 2014
 * @time 11:52:52 AM
 */
public class InfoNotificationPanel implements Initializable {
	...
	public static VBox load(String title, String message) {
		...
		try {
			...
			// load fxml file
			FXMLLoader fxmlLoader = new FXMLLoader(EquinoxTheme.getFXMLResource("InfoNotificationPanel.fxml"));
			fxmlLoader.load();

			// get controller
			InfoNotificationPanel controller = (InfoNotificationPanel) fxmlLoader.getController();
