...
/**
 * Class for data server statistics request failed exception.
 *
 * @author Murat Artim
 * @date 18 Jul 2018
 * @time 00:12:45
 */
public class DataServerStatisticsRequestFailedException extends Exception {

	/** Serial ID. */
	private static final long serialVersionUID = 1L;

	/** Server message. */
	private final DataServerStatisticsRequestFailed serverMessage;
	 ...
	 */
	public DataServerStatisticsRequestFailedException(DataServerStatisticsRequestFailed serverMessage) {
